...
import vans2 from '../images/vans2.jpg'
import balconyWithVan from '../images/balconyWithVan.jpg'

const AboutHeader = () => {
    return (
        <div className='w-full py-16 px-4'>
            <div className='mx-auto bg-gradient-to-r from-zinc-900 to-emerald-700'>
            ...
            <div className='max-w-[1240px] grid lg:grid-cols-2 mx-auto gap-4 p-8 md:p-16'>
                <img className='w-[500px] md:h-[500px] mx-auto rounded-md my-auto' src={vans2} alt="" />
            ...
            <div className='max-w-[1240px] grid lg:grid-cols-2 mx-auto gap-4 p-8 md:p-16'>
                ...
                <img className='w-[500px] md:h-[500px] mx-auto my-auto rounded-md' src={balconyWithVan} alt="" />
            </div>
            <div className='max-w-[1240px] grid lg:grid-cols-2 mx-auto gap-4 p-8 md:p-16'>
                <img className='w-[500px] md:h-[500px] mx-auto rounded-md my-auto' src={avatar} alt="" />
                <div className=' flex flex-col justify-center gap-2'>
